...
const PLACEHOLDER_ARTS = [
  (color: string) => (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs>
        <linearGradient id="g1a" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#D4A843" /><stop offset="100%" stopColor="#FF8C42" /></linearGradient>
        <linearGradient id="g1b" x1="0" y1="1" x2="1" y2="0"><stop offset="0%" stopColor="#4ECDC4" /><stop offset="100%" stopColor="#C4B0E8" /></linearGradient>
      </defs>
      ...
      <text x="140" y="60" textAnchor="middle" fill={color} fontFamily="sans-serif" fontSize="13" fontWeight="bold" letterSpacing="4" opacity="0.9">SPECTOV</text>
      <text x="140" y="80" textAnchor="middle" fill="#7A7090" fontFamily="monospace" fontSize="8" letterSpacing="2">BRAND ASSETS</text>
    </svg>
  ),
  (color: string) => (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      {[0,1,2,3,4,5,6].map(i => <rect key={i} x={18 + i*22} y={100} width="14" height={20 + Math.sin(i) * 15} rx="2" fill={color} opacity="0.7" />)}
      <text x="97" y="42" textAnchor="middle" fill={color} fontFamily="monospace" fontSize="10" fontWeight="bold">Notevera UI</text>
    </svg>
  ),
  (color: string) => (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs><linearGradient id="sky2" x1="0" y1="0" x2="0" y2="1"><stop offset="0%" stopColor="#2D1B69" /><stop offset="100%" stopColor="#F2A97E" stopOpacity="0.4" /></linearGradient></defs>
      ...
      <text x="140" y="155" textAnchor="middle" fill={color} fontFamily="serif" fontSize="9" opacity="0.7" letterSpacing="2">CAMPBOARD UI</text>
    </svg>
  ),
  (color: string) => (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <text x="140" y="130" textAnchor="middle" fill={color} fontFamily="sans-serif" fontSize="9" fontWeight="bold" letterSpacing="3">CHATBOT UX</text>
    </svg>
  ),
  (_color: string) => (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      <defs><linearGradient id="gt" x1="0" y1="0" x2="1" y2="1"><stop offset="0%" stopColor="#D4A843" /><stop offset="100%" stopColor="#C4B0E8" /></linearGradient></defs>
      <rect width="280" height="160" fill="#0D0B1E" />
      <line x1="20" y1="40" x2="260" y2="40" stroke="#2D1B69" strokeWidth="1" />
      <text x="140" y="72" textAnchor="middle" fill="url(#gt)" fontFamily="serif" fontSize="28" fontWeight="bold" letterSpacing="-1">NIMBARA</text>
      <text x="140" y="92" textAnchor="middle" fill="#F5F0E8" fontFamily="serif" fontSize="10" letterSpacing="3" opacity="0.6">PORTFOLIO IDENTITY</text>
      <line x1="20" y1="110" x2="260" y2="110" stroke="#2D1B69" strokeWidth="1" />
    </svg>
  ),
  (color: string) => (
    <svg viewBox="0 0 280 160" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
      ...
      <text x="140" y="148" textAnchor="middle" fill="#7A7090" fontFamily="monospace" fontSize="7" letterSpacing="3">GRAPHIC DESIGN</text>
    </svg>
  ),
];
...
export default function StudioDistrict() {
  return (
    <section
      id="design"
      aria-label="Graphic Design — The Studio District"
      style={{ position: "relative", overflow: "hidden" }}
    >
      {/* Expressive background paint splash */}
      ...
      <div className="section-wrapper">
        <DistrictHeader
          districtName="The Studio District"
          title="Things I've"
              ...
              >
                ...
                <div style={{ padding: "1.25rem", flex: 1, display: "flex", flexDirection: "column", gap: "0.5rem" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                    <h3 style={{ fontFamily: "var(--font-display)", fontWeight: 700, fontSize: "0.95rem", color: "var(--text-primary)", letterSpacing: "-0.01em", lineHeight: 1.3 }}>
                      {work.title}
                    </h3>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: "0.4rem", flexWrap: "wrap" }}>
                    ...
                    {work.tools.map((tool) => <span key={tool} className="tag" style={{ fontSize: "0.6rem" }}>{tool}</span>)}
                  </div>
                </div>
              </motion.article>
            );
        ...
        <motion.p
          ...
          style={{ textAlign: "center", marginTop: "2rem", fontFamily: "var(--font-mono)", fontSize: "0.7rem", color: "var(--text-muted)", letterSpacing: "0.08em" }}
        >
