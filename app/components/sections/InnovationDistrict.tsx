    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "1rem" }}>
        ...
        <ArrowUpRight
          size={18}
          aria-hidden="true"
          style={{ color: "var(--text-muted)", flexShrink: 0, marginTop: "0.2rem" }}
        />
      </div>
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            background: "var(--glass-02)", border: "1px solid var(--border-subtle)",
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          <h3 style={{
            ...
            letterSpacing: "-0.03em", color: "var(--text-primary)", marginTop: "0.4rem",
          }}>
            {project.title}
          </h3>
        </div>
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          <p style={{ fontFamily: "var(--font-mono)", fontSize: "0.65rem", color: "var(--text-muted)", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: "0.6rem" }}>
            Tech Stack
          </p>
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.4rem" }}>
            {project.techStack.map((tech) => (
        ...
        <div style={{ display: "flex", gap: "0.75rem" }}>
          <a href={project.githubUrl} target="_blank" rel="noopener noreferrer"
            className="btn-primary btn-outline" style={{ padding: "0.55rem 1.25rem", fontSize: "0.82rem" }}>
            <GithubIcon size={15} /> View on GitHub
          </a>
          <a href={project.liveUrl} target="_blank" rel="noopener noreferrer"
            className="btn-primary btn-brass" style={{ padding: "0.55rem 1.25rem", fontSize: "0.82rem" }}>
...
export default function InnovationDistrict() {
  ...
  return (
    <section id="projects" aria-label="Projects — Innovation District">
      <div className="section-wrapper">
        <SectionHeader
          districtLabel="Innovation District"
          title="Things I've"
          titleHighlight="Built"
          subtitle="Each project is a building in Nimbara — a real structure of code, design, and curiosity."
        />
